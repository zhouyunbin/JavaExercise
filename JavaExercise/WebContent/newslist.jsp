...
<body>
	...
	<div style="margin:15px"> <table id="flex1" style="display:none"></table> </div>       
        ...
        $("#flex1").flexigrid({
            url: '/admin/news/newsHandler.ashx?command=1&informtype=',
            dataType: 'json',
            colModel: [
                { display: '标题', name: 'title', width: 310, sortable: true, align: 'center' },
                { display: '修改时间', name: 'time', width: 100, sortable: true, align: 'left' },
                { display: '发布人', name: 'user', width: 80, sortable: true, align: 'left' },
                { display: '发布部门', name: 'department', width: 180, sortable: true, align: 'left' },
            ],
            sortname: "time",
            sortorder: "desc",
            singleSelect: true,
        ...
        function selectAccount() {
            ...
            window.open('/news/shownews.aspx?informtype=' + Request("informtype") + '&informno=' + id);
