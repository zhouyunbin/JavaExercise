...
<%
	FaqController ff=new FaqController();
	Faq fa=ff.getFaqbyId(Integer.parseInt(request.getParameter("informno")));
%>
   <form id="news" method="post" action="/admin/FaqHandler?cmd=modify">
   <input name="uid" style="display:none" value="<%= fa.getNewsid()%>">
    <p>标题：<input  name="title" size="80" style="margin:2px" value="<%= fa.getTitle()%>"/></p>
