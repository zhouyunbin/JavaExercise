			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right theme-container" >
					...
					<ul class="dropdown-menu" id="themes">
						<li><a data-value="classic" href="#"><i class="icon-blank"></i> 主题1</a></li>
						<li><a data-value="cerulean" href="#"><i class="icon-blank"></i> 主题2</a></li>
						<li><a data-value="cyborg" href="#"><i class="icon-blank"></i> 主题3</a></li>
						<li><a data-value="redy" href="#"><i class="icon-blank"></i> 主题4</a></li>
						<li><a data-value="journal" href="#"><i class="icon-blank"></i> 主题5</a></li>
						<li><a data-value="simplex" href="#"><i class="icon-blank"></i> 主题6</a></li>
						<li><a data-value="slate" href="#"><i class="icon-blank"></i> 主题7</a></li>
						<li><a data-value="spacelab" href="#"><i class="icon-blank"></i> 主题8</a></li>
						<li><a data-value="united" href="#"><i class="icon-blank"></i> 主题9</a></li>
					</ul>
				</div>
				<!-- theme selector ends -->
