...
<body>
	...
	<div class="maindiv" >
   <form id="news" method="post" action="/admin/VideoHandler?cmd=add" style="margin:20px">
	    <p>视频标题：<input  name="title" size="100" style="margin:2px" /></p>
	    <p>视频描述：<textarea  name="describe" size="240" style="margin:2px;height:50px;width:630px;" /></textarea></p>
